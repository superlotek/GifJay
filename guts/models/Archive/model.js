(function() {
  ...
  function init() {
    ...
    let stacy_txt = new THREE.TextureLoader().load('newskin2.jpg');
    ...
    loader.load(
      ...
      function(gltf) {
        ...
        let clips = fileAnimations.filter(val => val.name !== 'swingdance');
        ...
        let idleAnim = THREE.AnimationClip.findByName(fileAnimations, 'swingdance');
